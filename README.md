# genpark-hierarchical-hnsw-vector-index-ann-searcher-skill
...
> **GenPark AI Agent Skill** -- Hierarchical HNSW vector index approximate nearest neighbor searcher (Qdrant)
